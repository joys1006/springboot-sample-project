...
public class ApiErrorResponse implements IApiResponse, Serializable {
    ...
    public ApiErrorResponse(Throwable throwable) { this(throwable, HttpStatus.OK); }

    public ApiErrorResponse(Throwable throwable, HttpStatus httpStatus) {
        this(throwable, httpStatus, new HttpHeaders());
    }

    public ApiErrorResponse(Throwable throwable, HttpHeaders headers) { this(throwable, HttpStatus.OK, headers); }
    ...
    public ApiErrorResponse(String message, int code) { this(message, code, new HttpHeaders()); }
    ...
    public ErrorInfo getError() { return this.error; }
}
